...
Every task must advance one gate: intake, discovery, recursion, artifact
analysis, validation, scoring, review, fallback, or testing/cleanup. Subagents,
Claude, scanners, UI work, and providers are execution aids only; they do not
change this goal.
