...
def run_parallelizes_nested_mobile_member_result_batches_and_preserves_order(
    tmp_path: Path,
    monkeypatch,
) -> None:
    db_path = tmp_path / "engagement.db"
    ...
    def tracking_entry(result_entry):  # noqa: ANN001
        nonlocal active, peak
...
def run_android_app_bundle_findings(tmp_path: Path) -> None:
    db_path = tmp_path / "engagement.db"
