...
Progress:
- Verified B604 locally: doctor payload action items now add `command_args` arrays for executable `forge ...` commands while preserving existing command strings and leaving env/prose actions as empty arrays. Push is pending.
