...
class AWSAuditor:
    ...
    def run(
        ...
        _LOG.info("AWS audit completed: %d findings across %d services", 
                            ...
                            try:
                                ...
                                if not last_used.get("LastUsedDate"):
                                    finding = AWSFinding(
                                        ...
                                        evidence={"user_name": user_name, "create_date": str(create_date)},
                    ...
                    for instance in page["DBInstances"]:
                        ...
                        if not instance.get("StorageEncrypted", False):
                            finding = AWSFinding(
                                ...
                                evidence={"engine": instance.get("Engine"), "version": instance.get("EngineVersion")},
    ...
    def _check_lambda_role_permissions(self, function_name: str, role_arn: str, region: str) -> None:
