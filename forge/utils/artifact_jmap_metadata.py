...
def jmap_urls(text: str, *, base_url: str) -> list[str]:
    """Resolve concrete source-aware URLs from JMAP session metadata."""
...
def _url_values(value: object, *, url_key: bool = False) -> list[str]:
    ...
    if isinstance(value, dict):
        ...
        for key, item in value.items():
            ...
            values.extend(_url_values(item, url_key=url_key or key_text.endswith("url")))
        return values
    return []
