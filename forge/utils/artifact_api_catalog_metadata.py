...
_URL_KEYS = frozenset({"baseurl", "endpoint", "endpoints", "url", "urls"})


def api_catalog_urls(text: str, *, base_url: str) -> list[str]:
    """Resolve concrete source-aware URLs from API catalog metadata."""
