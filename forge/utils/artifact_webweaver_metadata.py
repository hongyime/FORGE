...
_URL_KEYS = frozenset({"endpoint", "endpoints", "url", "urls"})


def webweaver_urls(text: str, *, base_url: str) -> list[str]:
    """Resolve concrete source-aware URLs from WebWeaver metadata."""
