...
_CONNECTORS: tuple[ConnectorDefinition, ...] = (
    ...
    ConnectorDefinition(
        id="opengraph_plugin_interface",
        label="OpenGraph Plugin Interface",
        domain="identity_exposure",
        cost_profile="free_local",
        safety="passive_offline",
        description=(
            "Explore #15: Standardised forge.identity.v1 JSON schema for identity-provider",
            " adapters (HIBP, Holehe, Maigret, Sherlock, custom plugins). Provides",
            " parse_opengraph_payload / emit_opengraph_payload / adapt_provider_output",
            " transform helpers. No network calls — pure local schema layer.",
        ),
        capabilities=("identity_schema", "provider_normalisation", "passive_offline"),
        outputs=("identity_exposure",),
        input_formats=("forge.identity.v1", "hibp_breach", "holehe_result", "sherlock_result"),
        execution_paths=("forge.connectors.opengraph_plugin",),
