...
_BUILTIN_SEED: dict[str, list[dict]] = {
    "schtasks_legit_names": [
        {
            ...
            "description": "Keeps Microsoft Edge up to date",
            "trigger_pattern": "PT1H",
            "author": "Microsoft Corporation",
            "stealth_rank": 1,
        },
        {
            "name": "MicrosoftEdgeUpdateTaskMachineUA",
            "description": "Keeps Microsoft Edge up to date (UA)",
            "trigger_pattern": "P1D",
            "author": "Microsoft Corporation",
            "stealth_rank": 1,
        },
        {
            ...
            "description": "Keeps Google software up to date",
            "trigger_pattern": "PT1H",
            "author": "Google LLC",
            "stealth_rank": 1,
        },
        {
            ...
            "description": "Keeps Google software up to date (UA)",
            "trigger_pattern": "P1D",
            "author": "Google LLC",
            "stealth_rank": 1,
        },
        {
            "name": "OneDrive Reporting Task-S-1-5-21",
            "description": "OneDrive usage reporting",
            "trigger_pattern": "P1D",
            "author": "Microsoft Corporation",
            "stealth_rank": 2,
        },
        {
            "name": "MicrosoftOfficeUpdatesMachineCore",
            "description": "Keeps Microsoft Office up to date",
            "trigger_pattern": "PT1H",
            "author": "Microsoft Corporation",
            "stealth_rank": 2,
        },
        {
            "name": "NvTmRepDriver{B2FE1952-0186}",
            "description": "NVIDIA driver telemetry task",
            "trigger_pattern": "P1D",
        ...
        },
        {
            ...
            "description": "Background task maintenance",
            "trigger_pattern": "P1D",
            "author": "Microsoft Corporation",
            "stealth_rank": 3,
        },
        {
            "name": "MicrosoftEdgeShadowStackRollback",
            "description": "Microsoft Edge shadow stack rollback",
            "trigger_pattern": "PT1H",
            "author": "Microsoft Corporation",
            "stealth_rank": 4,
        },
        {
            "name": "SvcRestartTask",
            "description": "Service restart maintenance task",
            "trigger_pattern": "PT30M",
            "author": "Microsoft Corporation",
            "stealth_rank": 4,
        },
        {
            "name": "CCleaner Update",
            "description": "CCleaner automatic update",
            "trigger_pattern": "P1D",
            "author": "Piriform Ltd",
            "stealth_rank": 4,
        },
        {
            ...
            "description": "Adobe Acrobat periodic update check",
            "trigger_pattern": "PT1H",
            "author": "Adobe Systems",
            "stealth_rank": 2,
        },
        {
            "name": "MozillaDefaultBrowserAgent",
            "description": "Mozilla default browser agent task",
            "trigger_pattern": "P1D",
            "author": "Mozilla",
            "stealth_rank": 3,
        },
    ...
    "cron_legit_paths": [
        ...
        },
        {
            ...
            "description": "dpkg daily run",
            "distro_family": "debian",
            "stealth_rank": 1,
        },
        {
            "path": "/etc/cron.daily/logrotate",
            "description": "Log rotation daily",
            "distro_family": "any",
            "stealth_rank": 1,
        },
        {
            "path": "/etc/cron.daily/man-db",
            "description": "man-db cache update",
            "distro_family": "any",
            "stealth_rank": 1,
        },
        {
            "path": "/etc/cron.weekly/update-notifier",
            "description": "Update notifier weekly check",
            "distro_family": "debian",
            "stealth_rank": 2,
        },
        {
        ...
        },
        {
            ...
            "description": "Anacron job launcher",
            "distro_family": "any",
            "stealth_rank": 2,
        },
        {
            "path": "/etc/cron.daily/cracklib-runtime",
            "description": "cracklib dictionary update",
            "distro_family": "debian",
            "stealth_rank": 3,
        },
        {
            "path": "/etc/cron.hourly/0anacron",
            "description": "Anacron hourly starter",
            "distro_family": "rhel",
            "stealth_rank": 2,
        },
        {
        ...
        },
        {
            ...
            "description": "Rootkit Hunter daily scan",
            "distro_family": "any",
            "stealth_rank": 3,
        },
        {
            "path": "/etc/cron.daily/mlocate",
            "description": "mlocate database update",
            "distro_family": "any",
            "stealth_rank": 2,
        },
    ],
    ...
    "legit_service_names": [
        ...
        },
        {
            ...
            "binary_path": "C:\\ProgramData\\Microsoft\\Windows Defender\\Platform\\4.18.25030.1-0\\MsMpEng.exe",
            "stealth_rank": 1,
        },
        {
        ...
        },
        {
            ...
            "binary_path": "C:\\Windows\\system32\\svchost.exe -k NetworkService -p",
            "stealth_rank": 2,
        },
        {
        ...
        },
        {
            ...
            "binary_path": "C:\\Windows\\system32\\svchost.exe -k rpcss -p",
            "stealth_rank": 2,
        },
        {
        ...
        },
        {
            ...
            "binary_path": "C:\\Windows\\system32\\SearchIndexer.exe /Embedding",
            "stealth_rank": 3,
        },
        {
        ...
        },
        {
            ...
            "binary_path": "C:\\Windows\\system32\\svchost.exe -k LocalServiceNoNetworkFirewall -p",
            "stealth_rank": 3,
        },
        {
            "display_name": "Microsoft Office Click-to-Run",
            "binary_path": "C:\\Program Files\\Common Files\\Microsoft Shared\\ClickToRun\\OfficeClickToRun.exe /service",
            "stealth_rank": 2,
        },
    ],
}
